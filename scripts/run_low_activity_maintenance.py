#!/usr/bin/env python3
"""Run NexusScheduler.run_once() and sweep_expired_pending_cases() -- the periodic trigger neither has today.

Both functions exist and work, verified directly against the real
pipeline, but nothing calls either on a schedule -- this script is that
...
def main() -> int:
    ...
    report = {"run_once": run_result, "expired_candidate_ids": expired_ids, "expired_count": len(expired_ids)}
