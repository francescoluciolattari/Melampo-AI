...
- `memory/umls_cache.py`: caches crosswalk results in the encrypted store, so a licensed lookup happens once per HPO code, not on every normalisation attempt.
