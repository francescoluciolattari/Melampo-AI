...
- `connectors/pms_ema.py`: EMA's Product Management Service (PMS) Public API, FHIR R5, EU-authorised medicinal products -- the direct EU/Italy-relevant complement to DailyMed's US-only formulary, currently in public beta and requiring registration (`PMS_EMA_API_KEY`).
