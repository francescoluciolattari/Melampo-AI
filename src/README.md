...
- `evaluation/vetting_bench.py`: measures a candidate on vetting rather than navigation -- propose a mechanism, and let `mechanism_verification` score it against the graph; the graph is the judge, never another model.
